...
const CharacterSheetSidebarMenu = ({cardActiveList, handleSetCardActiveList }) =>{
    ...
    const runHandleCardActiveList = () =>{
        ...
        <div  className="left-0 w-20 flex flex-col bg-gray-700">
            ...
            {/* 6. Senses */}
            <SidebarBtn icon={<GiCrystalEye size="42" />} text={"Passive Senses"} />
            ...
            {/* 6. Proficiencies */}
            <SidebarBtn icon={<RiShieldStarLine size="42" />} text={"Proficiencies"} />
            ...
            {/* 8. Species Features */}
            <SidebarBtn icon={<BsPersonAdd size="42" />} text={"Species Features"} />

            {/* 9. Feats Features */}
            <SidebarBtn icon={<BsTrophy size="40" />} text={"Feats Features"} />

            {/* 10. Descriptions */}
            <SidebarBtn icon={<AiOutlineIdcard size="42" />} text={"Descriptions"} />
