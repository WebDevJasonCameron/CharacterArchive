...
VALUES
    ...
    ('Longsrider', '1st', '1 action', 'Touch', true, true, true, 'a pinch of dirt', '1 hour', false, false, 'Transmutation', '', 'You touch a creature. The target’s Speed increases by 10 feet until the spell ends.\n
     **Using a Higher-Level Spell Slot.** You can target one additional creature for each spell slot level above 1.', '', 'Player’s Handbook, pg. 293', 'buff, movement', ''),

    ('Protection from Evil and Good', '1st', '1 action', 'Touch', true, true, true, 'a flask of Holy Water worth 25+ GP, which the spell consumes', 'Concentration, up to 10 minutes', true, false, 'Abjuration', '', 'Until the spell ends, one willing creature you touch is protected against creatures that are Aberrations, Celestials, Elementals, Fey, Fiends, or Undead. The protection grants several benefits. Creatures of those types have Disadvantage on attack rolls against the target. The target also can’t be possessed by or gain the Charmed or Frightened conditions from them. If the target is already possessed, Charmed, or Frightened by such a creature, the target has Advantage on any new saving throw against the relevant effect.', '', 'Player’s Handbook, pg. 309', 'buff, debuff, warding', ''),

    ('Purify Food and Drink', '1st', '1 action + 10 minutes', '10 ft./5 ft. sphere', true, true, false, '', 'Instantaneous', false, true, 'Transmutation', '', 'You remove poison and rot from nonmagical food and drink in a 5-foot-radius Sphere centered on a point within range.', '', 'Player’s Handbook, pg. 310', 'utility', ''),
    ...
    ('Snare', '1st', '1 minute', 'Touch', false, true, true, '25 feet of rope, which the spell consumes', '8 hours', false, false, 'Abjuration', 'DEX 13', 'As you cast this spell, you use the rope to create a circle with a 5-foot radius on the ground or the floor. When you finish casting, the rope disappears and the circle becomes a magic trap.\n
     ...
     After the trap is triggered, the spell ends when no creature is restrained by it.', '', 'Xanathar''s Guide to Everything, pg. 165', 'control', ''),
    ...
    ('Speak with Animals', '1st', '1 action + 10 minutes', 'Self', true, true, false, '', '10 minutes', false, true, 'Divination', 'communication, social', 'For the duration, you can comprehend and verbally communicate with Beasts, and you can use any of the Influence action’s skill options with them.\n
     Most Beasts have little to say about topics that don’t pertain to survival or companionship, but at minimum, a Beast can give you information about nearby locations and monsters, including whatever it has perceived within the past day.', '', 'Player’s Handbook, pg. 318', 'communication, social', ''),
     ...
     **At Higher Levels.** When you cast this spell using a spell slot above 1st level, increase the spell’s effect by an additional 1d4 for every slot level above 1st.', '', 'Humblewood Campaign Setting, pg. 51', '', ''),
     ...
     **Using a Higher-Level Spell Slot.** The damage increases by 1d8 for each spell slot level above 1.', '', 'Player’s Handbook, pg. 334', 'damage, control', ''),
